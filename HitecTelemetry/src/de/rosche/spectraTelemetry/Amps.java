...
public final class Amps extends View {

	private static final String TAG = Amps.class.getSimpleName();
	...
	public Amps(Context context) {
		super(context);
		init();
	}

	public Amps(Context context, AttributeSet attrs) {
		super(context, attrs);
		init();
	}

	public Amps(Context context, AttributeSet attrs, int defStyle) {
	...
	private void drawScale(Canvas canvas) {
		...
		//canvas.drawArc(scaleRect, valueToAngle(20f) + 70f, valueToAngle(24f) - valueToAngle(10f), false, scaleGreenPaint);
		canvas.drawArc(scaleRect, 215f,110f, false, scaleGreenPaint);
		canvas.drawArc(scaleRect, 315f,120f, false, scaleRedPaint);
	...
	private void drawTitle(Canvas canvas) {
		...
		canvas.drawText("A", 50f, 65f, titlePaint);
	}
