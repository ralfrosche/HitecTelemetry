...
public final class Volts extends View {

	private static final String TAG = Volts.class.getSimpleName();
	...
	public Volts(Context context) {
		super(context);
		init();
	}

	public Volts(Context context, AttributeSet attrs) {
		super(context, attrs);
		init();
	}

	public Volts(Context context, AttributeSet attrs, int defStyle) {
	...
	private void drawScale(Canvas canvas) {
		...
		canvas.drawArc(scaleRect, 225f,100f, false, scaleGreenPaint);
		canvas.drawArc(scaleRect, 115f,110f, false, scaleRedPaint);
	...
	private void drawTitle(Canvas canvas) {
		...
		canvas.drawText("V", 50f, 65f, titlePaint);
	}
